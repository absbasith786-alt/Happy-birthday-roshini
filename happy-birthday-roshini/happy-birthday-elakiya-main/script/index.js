...
function animationTimeline() {
  ...
  tl.to(".timeline-container", 0.6, { visibility: "visible" })
    ...
    .to(".hbd-chatbox span", { visibility: "visible", duration: 1.5, stagger: 0.05 })
    .to(
      ".fake-btn",
      0.1,
      {
    ...
    .from(".idea-6 span", { scale: 3, opacity: 0, rotation: 15, duration: 0.8, stagger: 0.2 })
    .to(".idea-6 span", { scale: 3, opacity: 0, rotation: -15, duration: 0.8, stagger: 0.2 }, "+=1.5")
    ...
    .from(".wish-hbd span", { opacity: 0, y: -50, rotation: 150, skewX: "30deg", duration: 0.7, stagger: 0.1 })
    .fromTo(
      ".wish-hbd span",
      { scale: 1.4, rotationY: 150 },
      { scale: 1, rotationY: 0, color: "#FF4DA6", duration: 0.7, stagger: 0.1 },
      "party"
    )
    .from(
      ".wish h5",
